...
public class EquipItemService {
    ...
    equip weapons, armor and jewellery on character and enemy
    ...
    can have only 6 armor ( limiting to 1 of each: "helmet", "boots", "gloves", "shoulder plates", "chest piece", "belt" )
